...
# 웨일 프로필 경로 및 원본 폴더 이름 설정
Whale_profile_base_path = 'C:\\Users\\pc\\AppData\\Local\\Naver\\Naver Whale\\'
...
for vpn_key in vpn.keys():
    for attempt in range(3):  # 최대 3회 재시도
        ...
        if result.returncode == 0:
            ...
            # 프로필 폴더 복사
            source_path = os.path.join(Whale_profile_base_path, profile_source_folder)
            destination_path = os.path.join(Whale_profile_base_path, vpn_key)
