...
Edge_profile_base_path = 'C:\\Users\\pc\\AppData\\Local\\Microsoft\\Edge\\'
...
for vpn_key in vpn.keys():
    for attempt in range(3):  # 최대 3회 재시도
        ...
        if result.returncode == 0:
            ...
            # 프로필 폴더 복사
            source_path = os.path.join(Edge_profile_base_path, profile_source_folder)
            destination_path = os.path.join(Edge_profile_base_path, vpn_key)
